...
public class BingoWindow extends javax.swing.JFrame {
    ...
    // variable and datastructure declaration
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(13, 13, 13)
                                .addComponent(randomLetterLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(191, 191, 191)
                        .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void startGame() {
        ...
        // set free space to color green right away
        freeSpace.setBackground(Color.green);
        
        // start with calling numbers for game
            ...
            public void run() {
                try {
                    ...
                    do {
                        ...
                        // check board of computer players
                        checkBoardOfComputer();
                        
                        // display balls called
                        showAllBalls();
                        
                        // time before a next ball is called
                        Thread.sleep(3000);  // 3 seconds
                        
                        // check player boards to see if anyone has won yet
                        // if winner has been found, sets winnerNotFound to false
                        // so game is exited
                        // winnerIs is accounted to for to announce who won
    ...
    private void checkBoardOfComputer() {
        // checks all boards except users board since user board
        // is being checked when they press corresponding button on board
        for (int i = 0; i < playerMap.size(); i++) {
            if (i == 1) {
                i++;
            }
    ...
    private void winnerAnouncement() {
        if (winnerIs != -1) {
            if (winnerIs == 1) {
                ...
                JOptionPane.showMessageDialog(this, "Sorry! You lost to computer player #" + winnerIs);
            }
        }
    }

    // prints out called out balls on board
    private void showAllBalls() {
        ...
        for (Integer ball : gameMind.calledNumberList) {
            StringBuilder append = sb.append(ball).append(" ");
            if (++i % 10 == 0) {
                sb.append("<br/>");
            }
        }
